            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="{{ auth()->user()->profile_picture }}" alt="Profile Image" class="w-100 border-radius-lg shadow-sm">
                        <a href="{{ url('#') }}" class="btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2">
    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="/profil" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
